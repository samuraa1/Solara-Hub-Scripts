...
local function KJDH_fake_script() -- VegaXAndroidUI.Loading 
	...
	do
		...
		local ok, lib = pcall(function()
			local body = game:HttpGet("https://pandadevelopment.net/servicelib?service=vegax&core=roblox&param=v2", true)
		...
		PandaAuth = (ok and type(lib) == "table") and lib or {
			GetKey = function()
				return "https://vegax.gg/discord.html"
			end,
			ValidateKey = function(_, key)
				key = tostring(key or "")
				return key ~= "" and #key >= 8
			end,
		}
	end
